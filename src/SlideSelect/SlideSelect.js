...
const SlideInput = ({ disabled, name, onChange, tabIndex, value, set = [], ...rest }) => {
	...
	return <SlideWrapper { ...{ ...rest, disabled, list, name, onChange, tabIndex, value, set }} dropdown component={props => <React.Fragment>
			<Selection {...{...attrSet, ...props}}/>
			<select {...{ disabled, name, onChange, tabIndex, value }} >
